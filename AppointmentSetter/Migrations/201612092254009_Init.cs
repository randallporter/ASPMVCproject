namespace AppointmentSetter.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AppointmentSetter_ID = c.Int(nullable: false),
                        appointmentType_ID = c.Byte(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Users", t => t.appointmentAttender_ID, cascadeDelete: false)
                .ForeignKey("dbo.Users", t => t.AppointmentSetter_ID, cascadeDelete: false)
                .ForeignKey("dbo.AppointmentTypes", t => t.appointmentType_ID, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Appointments", "AppointmentSetter_ID", "dbo.Users");
            DropForeignKey("dbo.Appointments", "appointmentAttender_ID", "dbo.Users");
